    ...
    <div class="container">
        ...
        ?>
                    <tr>
                        ...
                        <td><?= $datos->id_operario ?></td>
                        <td><?= $datos->nombre ?></td>
                        <td><?= $datos->documento ?></td>
                        <td><?= $datos->salario ?></td>
                       
                        <td>
                        <a href="form_edit_op.php ?id=<?= $datos->id_operario?>" class="btn btn-small btn-warning" ><i class="fa-solid fa-pen-to-square"></i></a>
                           
                    
                    <a href="../controller/operators/delete_op.php ?id=<?= $datos->id_operario?>" class="btn btn-small btn-danger">
    ...
    ?>
            ...
            <div class="col-md-4">
                <div class="form-container">
                    ...
                    <form action="/reportes/controller/operators/add_op.php" method="post">
